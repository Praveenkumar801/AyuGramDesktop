...
public:
	...
	[[nodiscard]] bool sendPseudoReplyToDeleted() const { return _sendPseudoReplyToDeleted.current(); }
	...
	void setSendPseudoReplyToDeleted(bool val);
	...
	[[nodiscard]] rpl::producer<bool> sendPseudoReplyToDeletedValue() const { return _sendPseudoReplyToDeleted.value(); }
	[[nodiscard]] rpl::producer<bool> sendPseudoReplyToDeletedChanges() const { return _sendPseudoReplyToDeleted.changes(); }
...
private:
	...
	rpl::variable<bool> _sendPseudoReplyToDeleted = true;
